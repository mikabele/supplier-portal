...
import emil.builder.{AttachInputStream, AttachUrl, From, MailBuilder, Subject, TextBody, To}
...
case class EmailNotificationService[F[+_]: Async: Monad: MonadError[*[_], Throwable]: Timer: ContextShift](
